---
title: Compatibility
description: Compatibility utilities to help you check Nuxt version compatibility
---
...
Nuxt Kit utilities can be used in Nuxt 3, Nuxt 2 with Bridge and even Nuxt 2 without Bridge. To make sure your module is compatible with all versions, you can use the compatibility functions.
...
```ts
import { assertNuxtCompatibility, defineNuxtModule } from '@nuxt/kit'

export default defineNuxtModule({
  async setup(_options, nuxt) {
    await assertNuxtCompatibility({ nuxt: '^3.0.0' }, nuxt)
  },
})
```
...
[View source on GitHub](https://github.com/nuxt/nuxt/blob/main/packages/kit/src/compatibility.ts)
