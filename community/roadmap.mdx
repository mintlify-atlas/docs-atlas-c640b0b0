---
title: Roadmap
description: Discover what's coming next for Nuxt with our roadmap and development status reports.
---

<Card 
  title="Read the latest framework and ecosystem announcements" 
  icon="newspaper" 
  href="/blog">
</Card>
...
<CardGroup cols={1}>
  <Card 
    ...
    icon="github" 
    href="https://github.com/nuxt/nuxt/issues/13653">
  </Card>
  <Card 
    title="Rendering Optimizations: Today and Tomorrow" 
    icon="github" 
    href="https://github.com/nuxt/nuxt/discussions/16119">
  </Card>
  <Card 
    title="Nuxt Image: Performance and Status" 
    icon="github" 
    href="https://github.com/nuxt/image/discussions/563">
  </Card>
</CardGroup>
...
Each active version has its own nightly releases which are generated automatically. For more about enabling the Nuxt nightly release channel, see [the nightly release channel docs](/advanced/nightly-release-channel).

| Release               | Initial release     | End Of Life                | Docs                                                              |
|-----------------------|---------------------|----------------------------|-------------------------------------------------------------------|
| **5.x** (scheduled)   | Q1 2026 (estimated) | TBA                        | &nbsp;                                                            |
| **4.x** (stable)      | 2025-07-16          | 6 months after 5.x release | [nuxt.com](https://nuxt.com/docs/4.x/getting-started/introduction)                |
| **3.x** (maintenance) | 2022-11-16          | 2026-07-31                 | [nuxt.com](https://nuxt.com/docs/3.x/getting-started/introduction)                |
| **2.x** (unsupported) | 2018-09-21          | 2024-06-30                 | [v2.nuxt.com](https://v2.nuxt.com/docs/get-started/installation/) |
