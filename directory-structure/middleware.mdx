...
<Note>
Route middleware run within the Vue part of your Nuxt app. Despite the similar name, they are completely different from [server middleware](/directory-structure/server#server-middleware), which are run in the Nitro server part of your app.
</Note>
...
1. [`navigateTo`](/api/utils/navigate-to) - Redirects to the given route
2. [`abortNavigation`](/api/utils/abort-navigation) - Aborts the navigation, with an optional error message.
