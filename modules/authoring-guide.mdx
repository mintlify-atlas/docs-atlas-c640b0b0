...
<Tip>
Watch the [Vue School video about Nuxt module starter template](https://vueschool.io/lessons/navigating-the-official-starter-template?friend=nuxt).
</Tip>
...
Now that you've set up your module development environment, learn about the module structure and anatomy.

<Card title="Module Anatomy" icon="box" href="/modules/module-anatomy">
  Understand how Nuxt modules are structured
</Card>
