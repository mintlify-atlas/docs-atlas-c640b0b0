---
title: ES Modules
description: Nuxt uses native ES modules to provide better performance and modern JavaScript features.
---

This guide helps explain what ES Modules are and how to make your Nuxt app (or upstream library) compatible with ESM.
...
In this case, you need to manually interop the default export:
...
- **Avoid Node.js built-ins** and CommonJS or Node.js-only dependencies as much as possible to make your library usable in Browsers and Edge Workers without needing Nitro polyfills.
