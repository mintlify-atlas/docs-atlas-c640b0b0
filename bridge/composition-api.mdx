---
title: Composition API in Bridge
description: Learn how to migrate from legacy Composition API packages to Nuxt Bridge's built-in Composition API support.
---
...
```diff plugins/composition-api.js
- import Vue from 'vue'
